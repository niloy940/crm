    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bill-materials.update", [$billMaterial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_expenses') ? 'is-invalid' : '' }}" type="number" name="other_expenses" id="other_expenses" value="{{ old('other_expenses', $billMaterial->other_expenses) }}" step="0.01" required>
